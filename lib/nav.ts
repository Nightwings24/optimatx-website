...
export const allRoutes: Route[] = [
  ...
  { label: "Competitions", href: "/competitions", status: "live", sitemap: true },
  ...
  { label: "Media", href: "/media", status: "live", sitemap: true },
  { label: "Publications", href: "/publications", status: "live", sitemap: true },
  { label: "Discuss", href: "/discuss", status: "live", sitemap: true },
...
export const paletteCommands: CommandItem[] = [
  ...
  },
  {
    ...
    type: "route",
    href: "/media",
    keywords: ["photos", "videos", "recordings", "albums", "talks"],
  },
  {
    id: "publications",
    glyph: "✉",
    ...
    type: "route",
    href: "/publications",
    keywords: ["newsletter", "dispatch", "magazine", "journal", "archive"],
  },
  {
    id: "discuss",
    glyph: "«",
    ...
    type: "route",
    href: "/discuss",
    keywords: ["forum", "comments", "questions", "community", "chat"],
  },
  {
    id: "merch",
    glyph: "✦",
    ...
    type: "route",
    href: "/merch",
    keywords: ["merchandise", "tee", "hoodie", "stickers", "shop"],
  },
  {
    id: "alumni",
    glyph: "★",
